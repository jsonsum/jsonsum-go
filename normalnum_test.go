...
func TestNormalizeNum(t *testing.T) {
	tests := []struct {
		...
		{norm: "120003456789e-16", nums: []string{"1.20003456789e-05", "0.0000120003456789"}},
		{norm: "4617911111111111e-20", nums: []string{"4.617911111111111e-05", "0.00004617911111111111"}},
		{norm: "-4617911111111111e-20", nums: []string{"-4.617911111111111e-05", "-0.00004617911111111111"}},
	}
